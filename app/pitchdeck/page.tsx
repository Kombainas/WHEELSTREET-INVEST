...
async function MDXContent() {
  try {
    const contentPath = join(process.cwd(), 'content', 'pitch-deck.mdx')
    ...
    const lastUpdated = getLastUpdated('content/pitch-deck.mdx')
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Pitch Deck Not Available</h1>
        <p className="text-lg text-black/60">
          The pitch deck document could not be loaded. Please contact support.
        </p>
      </div>
    )
  }
